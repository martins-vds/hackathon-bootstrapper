      ...
      : [
          {
            priority: 5
            ruleType: 'MatchRule'
            action: firewallMode == 'Prevention' ? 'Allow' : 'Log'
            name: 'allowIps'
            state: 'Enabled'
            matchConditions: [
              {
          ...
          }
          {
            priority: 10
            ruleType: 'MatchRule'
            action: firewallMode == 'Prevention' ? 'Block' : 'Log'
            name: 'blockAll'
            state: 'Enabled'
            matchConditions: [
              {
      ...
      [
        {
          ...
          properties: {
            ...
            urlPathMap: {
              id: resourceId('Microsoft.Network/applicationGateways/urlPathMaps', gatewayName, 'url-path-map')
            }
          }
        }
      ],
